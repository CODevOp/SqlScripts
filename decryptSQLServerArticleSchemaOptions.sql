...
SET @intermediate= cast(cast(@schemaoption as BIGINT) & 0x02 as binary(8))
...
SET @intermediate= cast(cast(@schemaoption as BIGINT) & 0x04 as binary(8))
...
SET @intermediate= cast(cast(@schemaoption as BIGINT) & 0x08 as binary(8))
...
SET @intermediate= cast(cast(@schemaoption as BIGINT) & 0x20000000000 as binary(8))
